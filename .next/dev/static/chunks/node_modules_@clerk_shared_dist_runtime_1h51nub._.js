...
(()=>{
    const e = new Error("Cannot find module 'swr/infinite'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
(()=>{
    const e = new Error("Cannot find module 'swr/mutation'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
*/ function SWRConfigCompat({ swrConfig, children }) {
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(SWRConfig, {
        value: swrConfig
    }, children);
}
//#endregion
...
*/ const usePagesOrInfinite = (params)=>{
    ...
    const { data: swrData, isValidating: swrIsValidating, isLoading: swrIsLoading, error: swrError, mutate: swrMutate } = useSWR(typeof isSignedIn === "boolean" ? previousIsSignedIn === true && isSignedIn === false ? pagesCacheKey : isSignedIn ? shouldFetch ? pagesCacheKey : null : null : shouldFetch ? pagesCacheKey : null, !cacheMode && !!fetcher ? ({
    ...
    const { data: swrInfiniteData, isLoading: swrInfiniteIsLoading, isValidating: swrInfiniteIsValidating, error: swrInfiniteError, size, setSize, mutate: swrInfiniteMutate } = useSWRInfinite({
...
*/ function useStripeClerkLibs() {
    const clerk = useClerk();
    return useSWR("clerk-stripe-sdk", {
...
"[project]/node_modules/@clerk/shared/dist/runtime/versionSelector-Cvjb2d9m.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-BCyjSf6c.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ const clerkJsScriptUrl = (opts)=>{
    ...
    const version = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$versionSelector$2d$Cvjb2d9m$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["versionSelector"])(clerkJSVersion);
...
//# sourceMappingURL=node_modules_%40clerk_shared_dist_runtime_1h51nub._.js.map