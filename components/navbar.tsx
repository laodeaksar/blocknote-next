...
export function Navbar({ pageId }: NavbarProps) {
  ...
  if (!page) {
    return (
      <nav className="h-12 flex items-center px-4 border-b border-gray-100">
  ...
  return (
    <nav className="h-12 flex items-center justify-between px-4 border-b border-gray-100 bg-white">
